 ...
 * @author Admin
 */
public class doingQuizLesson extends HttpServlet {
...
//        processRequest(request, response);
        ...
        request.setAttribute("lqac", lqac);
        request.setAttribute("lessonID", lessonID);
        request.setAttribute("lesson", lesson);
        request.setAttribute("courseID", courseID);
        request.getRequestDispatcher("doingQuizLesson.jsp").forward(request, response);
    } 
