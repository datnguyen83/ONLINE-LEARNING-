                    ...
                    <div class="all" style=" color: #053f1b;margin-top: -50px;margin-left: 250px">
                        ...
                        <div class="khung" style="margin-top: 25px">
                            <div class="nhap" >
                                ...
                                <input type="text" name="routeName" class="form-input" style="width: 400px ;"  maxlength="100" required> 
                            </div>
...
<!--                                <div style="font-size: 15px;color: red">
                        ...
                        <div class="nhap" >
                            ...
                            <textarea name="content1" style="width: 400px;height: 100px;font-size: 19px;"  maxlength="2000" required></textarea>
                        </div>
                        <br>
                        <div class="nhap" >
                            ...
                            <textarea name="content2" style="width: 400px;height: 100px;font-size: 19px;" maxlength="2000" required></textarea>
                        </div>    <br>
                        <div class="nhap" >
                            <div style="margin-bottom: 10px">An / Hien
                                <a style="color: red">*</a>
                            </div>
                            <input type="text" name="status" class="form-input" style="width: 400px ;" required> 
                        </div>
                    </div>
