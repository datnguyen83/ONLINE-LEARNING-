                ...
                <div style="display: flex">
                    ...
                    <div style="margin-left: 50px ; margin-top: 20px;font-family: 'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol'">
                        ...
                        <div style="display: flex;margin-top: 60px">
                            <div style="width: 450px;height: 250px;border-color: black;border-radius: 16px;border:2px solid #e8e8e8">
                                <div style="display: flex">
                                    <div style="height: 100px">
                                        <h1 style="margin-top: 25px;margin-left: 20px;font-weight: 800;">Lộ trình học Front-end</h1> <br>
                                    ...
                                    <a >
                                        <img src="https://files.fullstack.edu.vn/f8-prod/learning-paths/2/63b4642136f3e.png" style="border-radius: 50% ; width: 110px;height: 110px;border-color: orange;border:4px solid orangered;margin-left: 11px;margin-top: 20px;cursor: pointer">    
                                    </a>
                                </div>
                                <div>
